module Lib.Helper (safeTake, split, splitList, solve) where

import           Data.Text    (Text)
import qualified Data.Text    as T
import qualified Data.Text.IO as TIO

-- Credits to cdimitroulas for this module. Copied from https://github.com/cdimitroulas/advent-of-code2022
